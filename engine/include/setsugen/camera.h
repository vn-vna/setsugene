...
{
public:
  Camera(Entity* entity, const Vec3F& position = Vec3F{}, const Vec3F& direction = Vec3F{});
  ...
  virtual Mat4x4F get_projection_matrix(float aspect) const = 0;
...
{
public:
  PerspectiveCamera(Entity* entity, const Vec3F& position = Vec3F{}, const Vec3F& direction = Vec3F{},
                    float near_plane = 0.5f, float far_plane = 1000.0f, float fov = 75.0f);
  ~PerspectiveCamera() override = default;

  float   get_near_plane() const;
  float   get_far_plane() const;
  float   get_fov() const;
  Mat4x4F get_projection_matrix(float aspect) const override;
