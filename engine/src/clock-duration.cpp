...
UInt64 Duration::get_day() const
{
  return m_data / cv_days;
}

UInt64 Duration::get_hour() const
{
  return m_data / cv_hours;
}

UInt64 Duration::get_minute() const
{
  return m_data / cv_minutes;
}

UInt64 Duration::get_second() const
{
  return m_data / cv_seconds;
}

UInt64 Duration::get_millisecond() const
{
